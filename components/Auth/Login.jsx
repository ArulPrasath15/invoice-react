...
function Login({login,deviceInfo}) {
    ...
    const  onSubmit = async (values)=>{
        ...
        try{
            const res=await signIn("email-pass",{ callbackUrl: `${process.env.SERVER_URL}/dashboard` }, payload);
    ...
    const onGoogle = (values)=>{
        const res=signIn("google",{ callbackUrl: `${process.env.SERVER_URL}/dashboard` });
        console.log("Result"+res);
