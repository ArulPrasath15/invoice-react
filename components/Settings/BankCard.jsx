...
import {EditOutlined, DeleteTwoTone,EyeOutlined} from '@ant-design/icons';
...
function BankCard({showModal,bank,deleteBank,viewModal}) {

    return (
        <>
            <Row gutter={24} onClick={()=>viewModal(bank)}>
                <Col span={24}>
                    <Text className={'text-secondary'}>Bank Name : </Text>
                    <Text className='px-2' strong>{bank.bank_name}</Text>
                </Col>
                <Col span={24}>
                    <Text className={'text-secondary'}>Account Holder Name : </Text>
